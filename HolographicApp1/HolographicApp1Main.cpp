...
HolographicApp1Main::HolographicApp1Main(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
    ...
    m_cameraAddedToken =
        m_holographicSpace->CameraAdded +=
            ref new Windows::Foundation::TypedEventHandler<HolographicSpace^, HolographicSpaceCameraAddedEventArgs^>(
                std::bind(&HolographicApp1Main::OnCameraAdded, this, _1, _2)
                );
    ...
    m_cameraRemovedToken =
        m_holographicSpace->CameraRemoved +=
            ref new Windows::Foundation::TypedEventHandler<HolographicSpace^, HolographicSpaceCameraRemovedEventArgs^>(
                std::bind(&HolographicApp1Main::OnCameraRemoved, this, _1, _2)
                );
...
HolographicApp1Main::~HolographicApp1Main()
{
...
HolographicFrame^ HolographicApp1Main::Update()
{
...
bool HolographicApp1Main::Render(Windows::Graphics::Holographic::HolographicFrame^ holographicFrame)
{
...
void HolographicApp1Main::SaveAppState()
{
    //
...
void HolographicApp1Main::LoadAppState()
{
    //
...
void HolographicApp1Main::OnCameraAdded(
...
void HolographicApp1Main::OnCameraRemoved(
    HolographicSpace^ sender,
